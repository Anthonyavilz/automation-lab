...
test("can search Google twice", async () => {
  ...
  await driver.findElement(By.name('q')).sendKeys("Tears of The Kingdom", Key.RETURN)
  await driver.wait(until.titleIs("Tears of The Kingdom - Google Search"), 1000)
  // await driver.sleep(2000)
  ...
  await driver.findElement(By.name('q')).sendKeys("Animal Crossing", Key.RETURN)
  await driver.wait(until.titleIs('Animal Crossing - Google Search'), 1000)
